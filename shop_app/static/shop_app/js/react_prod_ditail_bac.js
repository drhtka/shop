...
componentDidMount(){
    ...
    render() {//  render зарезервированное имя в реакте выводит даные
        return <div>
            ...
            <li className="btn-group list active" role="presentation"><a href="#" title="Списком" role="tab" data-toggle="tab"><i className="fa fa-th-list"/></a>
            </li>
            <li className="btn-group grid" role="presentation"><a href="#" title="Сеткой"><i className="fa fa-th-large" /></a>
            </li>
            </ul>
            </li>
            ...
            <li><a href=""> <span></span></a>
                ...
                <h4 className="panel-title"><a href=""><span className="counting-box">13</span> <span className="panel-title"></span></a></h4>
                </div>
                {'{'}% comment подкктегории%{'}'}<div className="panel-collapse collapse" id="collapseOne">
                <div className="panel-body">
                <ul>
                <li><a href="#"><span className="fa fa-caret-right" />Название подкатегории</a>
                </li>
                <li><a href="#"><span className="fa fa-caret-right" />Название подкатегории</a>
                </li>
                <li><a href="#"><span className="fa fa-caret-right" />Название подкатегории</a>
                ...
                <ul>
                <li className="show-link"><a href=""><span>Подробнее..</span></a><span className="fa fa-angle-right right-icon" />
                </li>
                <li className="add-to-card"><span className="fa fa-shopping-cart" /><a href="{% url 'shop_cart' %}?i={{ goodss.0 }}&name={{ goodss.1 }}&price={{ goodss.3 }}&img={{ goodss.4 }}"><span>В корзину</span></a>
                </li>
                </ul>
                </div>
                </div>
